...
<body>
  ...
  <div class="container bg-body pb-3" style="padding-top: 120px;">
    <div class="container bg-light p-5 m-4 rounded shadow">
      <h1 class="text-center mb-4">IRDO Registration Form</h1>
      <form action="config/prosesRegistrasi" method="POST" enctype="multipart/form-data">
        <input type="hidden" name="csrf_token" value="<?= $_SESSION["csrf_token"] ?>">
        <div class="mb-3">
          <label for="nama_tim" class="form-label"><i class="bi bi-people"></i>Team Name</label>
          <input type="text" class="form-control" id="nama_tim" name="nama_tim" required>
        </div>
        <div class="mb-3">
          <label for="asal_sekolah" class="form-label"><i class="bi bi-building"></i>School Name</label>
        ...
        <div class="row">
          <div class="col-md-4 mb-3">
            <label for="anggota1" class="form-label"><i class="bi bi-person"></i> Name of Member 1</label>
            <input type="text" class="form-control" id="anggota1" name="anggota1" required>
          </div>
          <div class="col-md-4 mb-3">
            <label for="anggota2" class="form-label"><i class="bi bi-person"></i> Name of Member 2</label>
            <input type="text" class="form-control" id="anggota2" name="anggota2" required>
          </div>
          <div class="col-md-4 mb-3">
            <label for="anggota3" class="form-label"><i class="bi bi-person"></i> Name of Member 3</label>
        ...
        <button type="submit" class="btn w-100" style="background-color :  #81cce3 !important;"><i
            class="bi bi-send"></i> Sent</button>
      </form>
    </div>
  </div>
