  ...
  <div class="container-fluid">
    ...
    <div class="container-fluid bg-body-tertiary">
      <div class="container text-center bg-body-tertiary pb-3">
        ...
        <?php if ($result->num_rows == 0): ?>
          <h4 style="padding: 150px 0px;">There is no news available!</h4>
        <?php else: ?>
    ...
    <div class="container-fluid bg-body">
      <div class="container text-center bg-body pb-3">
        ...
        <?php if ($result->num_rows == 0): ?>
          <h4 style="padding: 150px 0px;">There is no Announcement available!</h4>
        <?php else: ?>
          <div class="row pt-3 d-flex justify-content-center">
    ...
    <div class="container-fluid bg-body-tertiary">
      <div class="container text-center bg-body-tertiary pb-3">
        ...
        <div class="row pt-3 d-flex justify-content-center">
          <?php if ($result->num_rows == 0): ?>
            <h4 style="padding: 150px 0px;">There is no Downloads available!</h4>
          <?php else: ?>
    ...
    ?>
    <?php if ($result->num_rows == 0): ?>
      <h4 style="padding: 150px 0px;">There is no Photo available!</h4>
    <?php else: ?>
      <div class="container-fluid bg-body">
        <div class="container text-center bg-body pb-3">
