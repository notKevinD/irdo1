...
$query_lainnya = "SELECT headlineInggris, slug, timeStamp, foto FROM berita ORDER BY timeStamp DESC LIMIT 4";
...
<body>
    ...
    include 'views/en/komponen/navbar.php'; ?>

    <div class="container bg-body pb-5" style="padding-top: 40px">
        <div class="container bg-body">
            <h1 class="pt-1 text-center pb-5">News</h1>
            <div class="row">
                    ...
                    <ul class="list-unstyled pt-5 border-top border-black">
                        <?php while ($lain = $result_lainnya->fetch_assoc()): ?>
                            <li class="d-flex mb-3">
                                ...
                                <div>
                                    <a href="en/detailBerita/<?= $lain['slug'] ?>"
                                        class="text-dark fw-bold"><?= htmlspecialchars($lain['headlineInggris']) ?></a>
