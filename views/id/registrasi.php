...
<body>
  ...
  <div class="container-xxl">
    <div class="container bg-light p-5 mt-4 rounded shadow">
      <h2 class="text-center mb-4">Form Registrasi IRDO</h2>
      <form action="../config/proses_registrasi.php" method="POST" enctype="multipart/form-data">
        ...
        <button type="submit" class="btn btn-primary w-100"><i class="bi bi-send"></i> Kirim Registrasi</button>
      </form>
    </div>
  </div>
